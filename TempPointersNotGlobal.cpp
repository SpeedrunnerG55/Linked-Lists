...
inline bool empty(); // used in list and stack
...
inline SearchResults createNode(); //list stack and que
inline void displayInfo(Ptr temp1); //list stack and que
...
inline SearchResults createNode(){
  int ID;
